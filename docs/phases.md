...
| 22 | Admin Panel | ✅ | /brandara-admin — 5 screens (Dashboard, Workspaces, Features, Billing, AI), DB-driven tier/module access via AdminSetting, PlanFeatureService reads DB first. 13 tests passing |
