<x-layouts.app>
    ...
    <div class="mb-8">
        ...
        <p class="text-base-content/60 mt-1">Here's what's happening with your brand today.</p>
    </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div class="card bg-[#F5F3FF] border border-[#EDE9FE]">
            <div class="card-body p-5">
                ...
                <p class="text-3xl font-bold text-[#6D28D9] mt-1">0</p>
        ...
        <div class="card bg-[#EFF6FF] border border-[#DBEAFE]">
            <div class="card-body p-5">
                <p class="text-xs font-medium text-base-content/50 uppercase tracking-wide">Total reach</p>
                <p class="text-3xl font-bold text-[#1D4ED8] mt-1">0</p>
                <p class="text-xs text-base-content/40 mt-1">Across platforms</p>
            </div>
        </div>
        ...
        <div class="card bg-[#FFFBEB] border border-[#FEF3C7]">
            <div class="card-body p-5">
                ...
                <p class="text-3xl font-bold text-[#B45309] mt-1">0</p>
        ...
        <div class="card bg-[#FFF1F2] border border-[#FFE4E6]">
            <div class="card-body p-5">
                ...
                <p class="text-xs text-base-content/40 mt-1">Average this month</p>
            </div>
        </div>
    </div>
    ...
    <div class="card bg-base-100 border border-base-300">
        <div class="card-body p-6">
            <h2 class="font-semibold text-neutral mb-4">Get your brand ready in 3 steps</h2>
            <div class="space-y-3">
                <div class="flex items-center gap-3 p-3 rounded-lg bg-base-200">
                    ...
                    <a href="{{ route('my-brand') }}" class="btn btn-xs btn-primary">Start</a>
                </div>
                ...
                <div class="flex items-center gap-3 p-3 rounded-lg bg-base-200">
                    ...
                    <a href="{{ route('connections') }}" class="btn btn-xs btn-primary">Connect</a>
                </div>
                ...
                <div class="flex items-center gap-3 p-3 rounded-lg bg-base-200">
                    ...
                    <a href="{{ route('create') }}" class="btn btn-xs btn-primary">Write a post</a>
                </div>
            </div>
        </div>
    </div>
