                ...
                'pro' => [
                    ...
                    'sections'  => [
                        ['label' => 'Everything in Basic, plus', 'items' => [
                            ...
                            'AI Presence reports — see where your brand appears in ChatGPT, Gemini & Perplexity',
                            'Analytics dashboard',
                        ]],
                    ],
                ],
                'agency' => [
                    ...
                    'sections'  => [
                        ['label' => 'Everything in Growth, plus', 'items' => [
                            ...
                            'White-label reports',
                            'Advanced AI Presence — competitor tracking',
                            'Client AI Presence dashboards',
                            'Monthly AI Presence summary reports',
                            'Priority support',
                        ]],
                    ],
                ],
