...
@if(!$hasData)
    ...
    <div style="background:#F8FAFC; border:2px dashed #E2E8F0; border-radius:14px; padding:3rem 2rem; text-align:center;">
        ...
        <p style="font-size:0.95rem; font-weight:700; color:#0F172A; margin:0 0 0.5rem;">Your trend data is on its way</p>
        <p style="font-size:0.85rem; color:#64748B; margin:0; max-width:380px; margin-left:auto; margin-right:auto; line-height:1.6;">
            Brandara monitors trending topics, content formats, and competitor activity in your industry. Data will appear here once your platforms are connected and scanning begins.
        </p>
    </div>
    ...
    @if($activeTab === 'industry')
        <div style="background:#fff; border:1px solid #E2E8F0; border-radius:14px; overflow:hidden; box-shadow:0 1px 3px rgba(15,23,42,0.06);">
            <div style="padding:1rem 1.25rem; border-bottom:1px solid #F1F5F9; display:flex; align-items:center; justify-content:space-between;">
                <div>
                    <p style="font-size:0.875rem; font-weight:600; color:#0F172A; margin:0;">What's trending in your industry right now</p>
                    <p style="font-size:0.78rem; color:#94A3B8; margin:0.125rem 0 0;">Topics your audience is actively talking about — post on these while they're hot</p>
                </div>
            </div>
        ...
        <div style="display:flex; flex-direction:column; gap:1rem;">
            @foreach($contentFormats as $trend)
                @php
                    ...
                    $strengthColor = $trend->strength >= 80 ? '#16A34A' : ($trend->strength >= 60 ? '#D97706' : '#94A3B8');
                @endphp
                <div style="background:#fff; border:1px solid #E2E8F0; border-radius:14px; padding:1rem 1.25rem; box-shadow:0 1px 3px rgba(15,23,42,0.06);">
                    ...
                    @endif
                    <div style="display:flex; align-items:center; gap:0.375rem; flex-wrap:wrap; margin-bottom:0.875rem;">
                        @if($trend->tags)
                    ...
                    <div style="height:6px; background:#F1F5F9; border-radius:99px; overflow:hidden;">
                        <div style="height:100%; width:{{ $trend->strength }}%; background:#7C3AED; border-radius:99px;"></div>
                    </div>
                </div>
            @endforeach
        </div>
    ...
    @if($activeTab === 'competitor')
        <div style="display:flex; flex-direction:column; gap:1.25rem;">
            ...
            <div style="background:#fff; border:1px solid #E2E8F0; border-radius:14px; padding:1.25rem; box-shadow:0 1px 3px rgba(15,23,42,0.06);">
                ...
                <p style="font-size:0.78rem; color:#94A3B8; margin:0 0 1rem; line-height:1.5;">Add a competitor name, hashtag, or topic. Brandara watches for activity around it and surfaces what matters.</p>

                <div style="display:flex; gap:0.625rem; margin-bottom:0.875rem; flex-wrap:wrap;">
                    <input type="text" wire:model="newKeyword" placeholder="e.g. #PersonalBranding, Competitor Name"
                ...
                @if($trackedKeywords->isEmpty())
                    <p style="font-size:0.82rem; color:#94A3B8; margin:0;">No keywords tracked yet. Add one above to start monitoring.</p>
                @else
            ...
            <div style="background:#fff; border:1px solid #E2E8F0; border-radius:14px; overflow:hidden; box-shadow:0 1px 3px rgba(15,23,42,0.06);">
                <div style="padding:1rem 1.25rem; border-bottom:1px solid #F1F5F9;">
                    <p style="font-size:0.875rem; font-weight:600; color:#0F172A; margin:0;">What's happening in your competitive space</p>
                    <p style="font-size:0.78rem; color:#94A3B8; margin:0.125rem 0 0;">Activity around competitors and keywords relevant to your brand</p>
                </div>
