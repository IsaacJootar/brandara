# Brandara — Codex Master Instructions
...
**Builder:** Solo founder, non-technical. Codex is the engineering team.
...
| AI | Anthropic Codex API (Codex-sonnet-4-5) |
...
| AI dev assistant | Laravel Boost (MCP server for Codex) |
...
4. **Failures are handled gracefully** — every external API call (Codex,
...
Laravel Boost gives Codex real-time access to your codebase.
...
Then in Codex settings, enable the laravel-boost MCP server.
This lets Codex read your routes, models, schema, and logs live.
